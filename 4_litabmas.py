...
import time
import io  # <-- Menangani konversi file Excel
    ...
    with tab3:
        ...
        if selected_dosen:
            ...
            if len(judul_dosen) >= 3:
                try:
                    ...
                    # --- PERBAIKAN: Hitung jumlah topik yang aman (mencegah error n_components > n_features) ---
                    ...
                    # Menampilkan multi-topik dalam grid kolom (2 kolom per baris)
        ...
        if st.button("Mulai Hitung Semua Dosen & Ekspor Excel"):
            ...
            if dosen_topics_all:
                ...
                # Proses Export DataFrame ke Excel di Memory
                buffer = io.BytesIO()
                ...
                st.download_button(
                    ...
                    file_name="Topik_Semua_Dosen.xlsx",
